import{r as o,j as m}from"./iframe-Bd70UBfQ.js";import{a as x}from"./mergeRefs-BlmmrTdi.js";import{$ as f,e as h}from"./utils-BmyyYDYY.js";const b=a=>{const{inputContext:r,children:i}=a,e=o.Children.only(i);if(!o.isValidElement(e))throw new Error("Expected valid element");const t=e.props,c=t.ref,[s,l]=f(t,c,r),p=x(n=>{(n instanceof HTMLInputElement||n instanceof HTMLTextAreaElement)&&(n.value=String(s.value??""))},l),d={...s,value:void 0,ref:p},u={...t,ref:void 0,value:void 0};return m.jsx(h,{values:[[r,d]],children:o.cloneElement(e,u)})};b.__docgenInfo={description:`React Aria (accidentally?!) enforces controlled inputs by always setting the
