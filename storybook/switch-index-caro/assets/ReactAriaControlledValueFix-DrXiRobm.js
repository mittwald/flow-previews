import{j as l}from"./jsx-runtime-D_zvdyIk.js";import{r as a}from"./index-CgfFrydU.js";import{$ as d,b as u}from"./utils-CEW6KzsL.js";const m=s=>{const{inputContext:n,children:i,props:e}=s,t=a.Children.only(i);if(!a.isValidElement(t))throw new Error("Expected valid element");const o=t.props,p=o.ref,[r,c]=d(o,p,n);return e&&typeof e=="object"&&!("value"in e)&&delete r.value,l.jsx(u,{values:[[n,{...r,ref:c}]],children:t})};m.__docgenInfo={description:`React Aria (accidentally?!) enforces controlled inputs by always setting the
