...
> Block quote
 ...
 2. Ordered list item 2`})},r={},o={args:{color:"dark"},globals:{backgrounds:"light"}},t={args:{color:"light"},globals:{backgrounds:"dark"}},i={args:{headingOffset:2}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:"{}",...r.parameters?.docs?.source}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  args: {
    color: "dark"
  },
  globals: {
...
}`,...i.parameters?.docs?.source}}};const Dr=["Default","Dark","Light","WithOffset"];export{o as Dark,r as Default,t as Light,i as WithOffset,Dr as __namedExportsOrder,xr as default};
